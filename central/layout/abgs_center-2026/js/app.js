! function a(b, c, d) {
    ...
    "/node_modules/jquery/dist/jquery.js": [function(a, b, c) {
        ! function(a, c) {
            "use strict";
            ...
            function oa(a, b, c, d, e) {
                for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o; n++)
                    ...
                    for (g = g || l.appendChild(b.createElement("div")), h = (ia.exec(f) || ["", ""])[1].toLowerCase(), i = ka[h] || ka._default, g.innerHTML = i[1] + r.htmlPrefilter(f) + i[2], k = i[0]; k--;) g = g.lastChild;
                    r.merge(m, g.childNodes), g = l.firstChild, g.textContent = ""
                } else m.push(b.createTextNode(f));
                for (l.textContent = "", n = 0; f = m[n++];)
                    if (d && r.inArray(f, d) > -1) e && e.push(f);
                    else if (j = r.contains(f.ownerDocument, f), g = la(l.appendChild(f), "script"), j && ma(g), c)
                    for (k = 0; f = g[k++];) ja.test(f.type || "") && c.push(f);
                return l
            }
            ...
            function Ta(a) {
                if (a in Sa) return a;
                for (var b = a[0].toUpperCase() + a.slice(1), c = Ra.length; c--;)
            ...
            var x = function(a) {
                    ...
                    if (!e && ((b ? b.ownerDocument || b : v) !== n && m(b), b = b || n, p)) {
                        ...
                        if (c.qsa && !A[a + " "] && (!q || !q.test(a))) {
                            if (1 !== w) s = b, r = a;
                                ...
                                for ((k = b.getAttribute("id")) ? k = k.replace(ba, ca) : b.setAttribute("id", k = u), o = g(a), h = o.length; h--;) o[h] = "#" + k + " " + ra(o[h]);
                                r = o.join(","), s = $.test(a) && pa(b.parentNode) || b
                            }
                            if (r) try {
                ...
                function wa(a, b, c, d, e, f) {
                    return d && !d[u] && (d = wa(d)), e && !e[u] && (e = wa(e, f)), ha(function(f, g, h, i) {
                        var j, k, l, m = [],
                            n = [],
                            o = g.length,
                        ...
                        } else r = va(r === g ? r.splice(o, r.length) : r), e ? e(null, g, r, i) : G.apply(g, r)
                    })
                }
                        ...
                        if (c = d.relative[a[i].type]) m = [sa(ta(m), c)];
                            ...
                            if (c = d.filter[a[i].type].apply(null, a[i].matches), c[u]) {
                                ...
                                return wa(i > 1 && ta(m), i > 1 && ra(a.slice(0, i - 1).concat({
                                    value: " " === a[i - 2].type ? "*" : ""
                                })).replace(P, "$1"), c, i < e && xa(a.slice(i, e)), e < f && xa(a = a.slice(e)), e < f && ra(a))
                            }
                            m.push(c)
                        }
                    return ta(m)
                    ...
                    var c = b.length > 0,
                        ...
                        f = function(f, g, h, i, k) {
                            ...
                            if (r += s, c && s !== r) {
                                ...
                                G.apply(i, u), k && !f && u.length > 0 && r + b.length > 1 && fa.uniqueSort(i)
                            }
                            return k && (w = y, j = v), t
                        };
                    return c ? ha(f) : f
                ...
                c = fa.support = {}, f = fa.isXML = function(a) {
                    ...
                    return g !== n && 9 === g.nodeType && g.documentElement ? (n = g, o = n.documentElement, p = !f(n), v !== n && (e = n.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", da, !1) : e.attachEvent && e.attachEvent("onunload", da)), c.attributes = ia(function(a) {
                        return a.className = "i", !a.getAttribute("className")
                    }), c.getElementsByTagName = ia(function(a) {
                        return a.appendChild(n.createComment("")), !a.getElementsByTagName("*").length
                    }), c.getElementsByClassName = Y.test(n.getElementsByClassName), c.getById = ia(function(a) {
                    ...
                    }, r = [], q = [], (c.qsa = Y.test(n.querySelectorAll)) && (ia(function(a) {
                    ...
                    })), (c.matchesSelector = Y.test(s = o.matches || o.webkitMatchesSelector || o.mozMatchesSelector || o.oMatchesSelector || o.msMatchesSelector)) && ia(function(a) {
                    ...
                    pseudos: {
                        ...
                        lang: ha(function(a) {
                            return U.test(a || "") || fa.error("unsupported lang: " + a), a = a.replace(_, aa).toLowerCase(),
                                function(b) {
                                    var c;
                                    do
                ...
                return qa.prototype = d.filters = d.pseudos, d.setFilters = new qa, g = fa.tokenize = function(a, b) {
                    ...
                    if (e = e || [], 1 === o.length) {
                        ...
                        for (i = V.needsContext.test(a) ? 0 : j.length; i-- && (k = j[i], !d.relative[l = k.type]);)
                            if ((m = d.find[l]) && (f = m(k.matches[0].replace(_, aa), $.test(j[0].type) && pa(b.parentNode) || b))) {
                                if (j.splice(i, 1), a = f.length && ra(j), !a) return G.apply(e, f), e;
                                break
                            }
                    }
                    return (n || h(a, o))(f, b, !p, e, !b || $.test(a) && pa(b.parentNode) || b), e
                        ...
                        add: function() {
                            return f && (c && !b && (h = f.length - 1, g.push(c)), function b(c) {
                                r.each(c, function(c, d) {
                                    r.isFunction(d) ? a.unique && j.has(d) || f.push(d) : d && d.length && "string" !== r.type(d) && b(d)
                                })
                ...
                data: function(a, b) {
                    ...
                    if (void 0 === a) {
                        if (this.length && (e = W.get(f), 1 === f.nodeType && !V.get(f, "hasDataAttrs"))) {
                            for (c = g.length; c--;) g[c] && (d = g[c].name, 0 === d.indexOf("data-") && (d = r.camelCase(d.slice(5)), Z(f, d, e[d])));
            ...
            r.event = {
                ...
                add: function(a, b, c, d, e) {
                    ...
                    if (q)
                        for (c.handler && (f = c, c = f.handler, e = f.selector), e && r.find.matchesSelector(pa, e), c.guid || (c.guid = r.guid++), (i = q.events) || (i = q.events = {}), (g = q.handle) || (g = q.handle = function(b) {
                                return "undefined" != typeof r && r.event.triggered !== b.type ? r.event.dispatch.apply(a, arguments) : void 0
                            }), b = (b || "").match(K) || [""], j = b.length; j--;) h = sa.exec(b[j]) || [], n = p = h[1], o = (h[2] || "").split(".").sort(), n && (l = r.event.special[n] || {}, n = (e ? l.delegateType : l.bindType) || n, l = r.event.special[n] || {}, k = r.extend({
                            type: n,
                            origType: p,
                            data: d,
                            handler: c,
                    ...
                    finish: function(a) {
                        return a !== !1 && (a = a || "fx"), this.each(function() {
                            var b, c = V.get(this),
                                ...
                                f = r.timers,
                                g = d ? d.length : 0;
                            for (c.finish = !0, r.queue(this, a, []), e && e.stop && e.stop.call(this, !0), b = f.length; b--;) f[b].elem === this && f[b].queue === a && (f[b].anim.stop(!0),
                                f.splice(b, 1));
    ...
    "/src/app.js": [function(a, b, c) {
        ...
        var d = a("./components/navbar/navbar"),
            f = (D(d), a("./components/login/login")),
            h = (D(f), a("./elements/table/datatable")),
            j = (D(h), a("./elements/chart/chart")),
            l = (D(j), a("./elements/dropdown/sidebar")),
            n = (D(l), a("./elements/form/form")),
            p = (D(n), a("./elements/code/code")),
            r = (D(p), a("./elements/tab/tab")),
            t = (D(r), a("./components/messaging/messaging")),
            v = (D(t), a("./elements/toggle/toggle")),
            x = (D(v), a("./elements/floating/button")),
            z = (D(x), a("./components/theming/theming")),
            B = (D(z), a("./components/demo"));
        D(B)
    }, {
        "./components/demo": "/src/components/demo.js",
        "./components/login/login": "/src/components/login/login.js",
        "./components/messaging/messaging": "/src/components/messaging/messaging.js",
        "./components/navbar/navbar": "/src/components/navbar/navbar.js",
        "./components/theming/theming": "/src/components/theming/theming.js",
        "./elements/chart/chart": "/src/elements/chart/chart.js",
        "./elements/code/code": "/src/elements/code/code.js",
        "./elements/dropdown/sidebar": "/src/elements/dropdown/sidebar.js",
        "./elements/floating/button": "/src/elements/floating/button.js",
        "./elements/form/form": "/src/elements/form/form.js",
        "./elements/tab/tab": "/src/elements/tab/tab.js",
        "./elements/table/datatable": "/src/elements/table/datatable.js",
        "./elements/toggle/toggle": "/src/elements/toggle/toggle.js"
    }],
    "/src/components/demo.js": [function(a, b, c) {
        "use strict";
        $(".ct-chart-browser").length && ! function() {
            var a = {
                    series: [1e3, 480, 705, 105, 50]
                },
                b = function(b, c) {
                    return b + c
                };
            new Chartist.Pie(".ct-chart-browser", a, {
                labelInterpolationFnc: function(d) {
                    return Math.round(d / a.series.reduce(b) * 100) + "%"
                },
                labelPosition: "inside",
                startAngle: 270
            })
        }(), $(".ct-chart-os").length && ! function() {
            var a = {
            ...
            new Chartist.Pie(".ct-chart-os", a, {
                labelInterpolationFnc: function(d) {
                    return Math.round(d / a.series.reduce(b) * 100) + "%"
                },
                startAngle: 270,
        ...
        }(), $(".tab-stats a[data-toggle='tab']").on("shown.bs.tab", function(a) {
            $(a.currentTarget.hash).find(".chart").each(function(a, b) {
                b.__chartist__.update()
            })
        }), $(".ct-chart-sale").length && new Chartist.Line(".ct-chart-sale", {
            ...
            series: [
                [2710, 2810, 4210, 8010, 19158, 35326, 80837, 79477, 88561, 67807, 70837, 55261, 66216, 10516, 13493, 12e3, 14253, 33506, 56326, 78986, 20747, 44165, 13817]
            ]
        }, {
            axisX: {
                position: "center"
            ...
            axisY: {
                offset: 0,
                showLabel: !1,
                labelInterpolationFnc: function(b) {
                    return b / 1e3 + "k"
                }
            },
            chartPadding: {
    ...
    "/src/components/login/login.js": [function(a, b, c) {
        "use strict";
        ...
        var d = a("jquery"),
            e = f(d),
            g = null;
        (0, e.default)(".app-login form").on("submit", function(a) {
            a.preventDefault(), (0, e.default)(".app-login .app-container").addClass("__loading"), clearTimeout(g), g = setTimeout(function() {
                (0, e.default)(".app-login .app-container").removeClass("__loading")
            }, 3e3)
        })
    }, {
        jquery: "/node_modules/jquery/dist/jquery.js"
    }],
    "/src/components/messaging/messaging.js": [function(a, b, c) {
        "use strict"
    }, {}],
    "/src/components/navbar/navbar.js": [function(a, b, c) {
        "use strict";
        var d = [{
            value: "Andorra",
            data: "AD"
        ...
        $("#search").autocomplete({
            lookup: d
        }), $(".sidebar-toggle").bind("click", function(a) {
            $("#sidebar").toggleClass("active"), $(".app-container").toggleClass("__sidebar")
        }), $(".navbar-toggle").bind("click", function(a) {
            $("#navbar").toggleClass("active"), $(".app-container").toggleClass("__navbar")
        })
    }, {}],
    "/src/components/theming/theming.js": [function(a, b, c) {
        "use strict";
    ...
    "/src/elements/chart/chart.js": [function(a, b, c) {
        "use strict";
        $(".ct-chart").length && new Chartist.Line(".ct-chart", {
            ...
            fullWidth: !0,
            lineSmooth: !1
        }), $(".ct-chart-bar").length && new Chartist.Bar(".ct-chart-bar", {
            ...
            new Chartist.Pie(".ct-chart-pie", a, {
                labelInterpolationFnc: function(d) {
                    return Math.round(d / a.series.reduce(b) * 100) + "%"
                }
            })
        }(), $(".ct-chart-donut").length && ! function() {
            var a = {
                    series: [5, 3, 4]
                },
                b = function(b, c) {
            ...
            new Chartist.Pie(".ct-chart-donut", a, {
                labelInterpolationFnc: function(d) {
                    return Math.round(d / a.series.reduce(b) * 100) + "%"
                },
                donut: !0,
        ...
        }(), $(".ct-chart-bi-polar").length && new Chartist.Line(".ct-chart-bi-polar", {
        ...
        }), $(".ct-chart-stack-bar").length && new Chartist.Bar(".ct-chart-stack-bar", {
            labels: ["Q1", "Q2", "Q3", "Q4"],
            series: [
                [8e5, 12e5, 14e5, 13e5],
                [2e5, 4e5, 5e5, 3e5],
            ...
            "bar" === a.type && a.element.attr({
                style: "stroke-width: 30px"
            })
        })
    }, {}],
    "/src/elements/code/code.js": [function(a, b, c) {
        "use strict";
        hljs.initHighlightingOnLoad()
    }, {}],
    "/src/elements/dropdown/sidebar.js": [function(a, b, c) {
        "use strict"
    }, {}],
    "/src/elements/floating/button.js": [function(a, b, c) {
        "use strict";
        $(document).click(function(a) {
            $(a.target).closest(".btn-floating").length || $(".btn-floating .toggle-content").is(":visible") && $(".btn-floating").toggleClass("active")
        })
    }, {}],
    "/src/elements/form/form.js": [function(a, b, c) {
        "use strict";
        $(".select2").select2()
    }, {}],
    "/src/elements/tab/tab.js": [function(a, b, c) {
        "use strict"
    }, {}],
    "/src/elements/table/datatable.js": [function(a, b, c) {
        "use strict";
        $(".datatable").DataTable({
    ...
    "/src/elements/toggle/toggle.js": [function(a, b, c) {
        "use strict";

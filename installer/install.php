...
JS;
        ...
        $contents = preg_replace(
            ...
            ['vpscloud-login.css?v=20260902-1', 'vpscloud-login.js?v=20260902-1'],
            $contents
        );
